...
\begin{document}
  ...
  \begin{sloppypar}
    ...
    plasuje się w tym zestawieniu na drugim miejscu.
    ...
    Wybrane z wykonanych przeze mnie implementacji wykazują kilkukrotne skrócenie czasu pracy
    programu. Dotyczy to przede wszystkim wariantu w języku Python z kompilacją JIT oraz
    wariantu w języku Rust wykorzystującego OpenBLAS. Wytworzony kod został zamieszczony
