...
\begin{document}
  ...
  \begin{sloppypar}
    ...
    czasu pracy skompilowanej wersji w języku Python opierającej się na bibliotece NumPy
    wykorzystujące macierze $\rho_{1}$ - $\rho_{6}$. kompilacja nie poskutkowała
    istotnym skróceniem czasu pracy programu względem wariantu bez AOT, różnice wynoszą koło
    1\%. Uzysk ten może być spowodowany usunięciem szczątkowego obciążenia ze strony interpretera,
    które nie jest mierzalne podczas krótszych testów z mniejszymi macierzami. Możliwe jest
    również że ta różnica wynika z korzystniejszych warunków losowo zapewnionych przez system
    operacyjny.
    ...
    \label{plots-single-precision} Wszystkie testy wydajności z dla obliczeń
    ...
    profilować zachowanie interpretera. Do profilowania wykorzystałem macierz $64\times64$.
    ...
    spodziewać sie w przypadku wielu innych programów skupiających się na obliczeń
    macierzowych - kompilacja JIT jest w stane dość skutecznie usunąć wady języka Python.
    Wymaga to poświęcenia pewnej części swobody którą ten język daje, ale ciągle
    pozostawia jej na tyle dużo, że proces pisania kodu jest mniej szybszy niż w przypadku
