...
\begin{document}
  ...
  \begin{sloppypar}
    ...
    jest stan separowalny $\rho_{1}$, który jest stanem separowalnym. Przez stan separowalny
    rozumiemy mieszaninę stanów produktowych, w których każdy podukład opisany jest
    niezależnie od pozostałych. Następnie program postępuje zgodnie z krokami:
    ...
    separowalny. W przeciwnym wypadku stan jest splątany. Oznacza to, że części składowe
    układu nie mogą być opisane jako oddzielne systemy, a informacje o jednej części mają
    wpływ na opis drugiej.
